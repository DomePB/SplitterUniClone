...
class GruppeTest {
    ...
    void personHinzufuegen() {
        ...
        Gruppe gruppe = new Gruppe("gruppeName", new ArrayList<>(), new ArrayList<>(), true,UUID.randomUUID());
    ...
    void addMitglieder() {
        ...
        Gruppe gruppe = new Gruppe("gruppeName", ausgabe, new ArrayList<>(List.of(user)), true,UUID.randomUUID());
